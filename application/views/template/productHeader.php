        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <!-- <a class="nav-link" href="account">My account -->
                <?php if (isset($custname)){ ?>
                     <?php if ($custname != '') { ?>
                               <a  class="nav-link" href="<?php echo base_url();?>account"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Hi! <?php echo "$custname ";?></a>
                      <?php } else{?><?php } ?>
                 <?php } ?>
            ...
            <li class="nav-item">
              ...
              <?php if (isset($custname)){ ?>
                   <?php if ($custname != '') { ?>
                             <a  class="nav-link" href="<?php echo base_url();?>logout"><i class="fa fa-sign-out" aria-hidden="true"></i> Sign out</a>
                    <?php } else{?>
                  <?php } ?>
                  <!-- end else -->
               <?php } ?>
